import {HuffmanCoder} from './script.js';
onload = function(){
    ...
    encode.onclick = function() {
        ...
        const fileReader = new FileReader(); // we need a object to read the content of file
        ...
        fileReader.readAsText(uploadedFile,"UTF_8");
    ...
    decode.onclick = function() {
        ...
        fileReader.onload = function (fileLoadedEvent) {
            ...
            let [decoded, tree_strcture, info] = coder.decode(text);
